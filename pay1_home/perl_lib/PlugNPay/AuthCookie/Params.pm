package PlugNPay::AuthCookie::Params;
$PlugNPay::AuthCookie::Params::VERSION = '3.26';
# ABSTRACT: AuthCookie Params Driver for mod_perl 2.x

use strict;
use warnings;
use base 'PlugNPay::AuthCookie::Params::Base';
...
PlugNPay::AuthCookie::Params - AuthCookie Params Driver for mod_perl 2.x
...
This class handles CGI form data for L<PlugNPay::AuthCookie>.  It will try to use
