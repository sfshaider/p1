package PlugNPay::AuthCookie::Params::Base;
$PlugNPay::AuthCookie::Params::Base::VERSION = '3.26';
...
sub _new_instance {
    ...
    load_class('PlugNPay::AuthCookie::Params::CGI');

    return PlugNPay::AuthCookie::Params::CGI->new($r);
}
