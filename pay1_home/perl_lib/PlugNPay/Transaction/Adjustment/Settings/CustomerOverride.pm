package PlugNPay::Transaction::Adjustment::Settings::CustomerOverride;
...
sub _loadModeData {
  ...
  my $sth = $dbs->prepare('pnpmisc',q/
    SELECT id,mode,enabled,name,description FROM adjustment_customer_override
  /);
