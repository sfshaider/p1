package PlugNPay::Transaction::Adjustment::Settings::FailureMode;
...
sub _loadModeData {
  ...
  my $sth = $dbs->prepare('pnpmisc',q/
    SELECT id,mode,enabled,name,description FROM adjustment_failure_mode
  /);
