...
sub head {
  ...
  print  "<html>\n";
  print  "<head>\n";
  print  "<title>PlugnPay/Cross Selling Administration Area</title>\n";
  ...
  print "<tr><td align=\"center\" colspan=\"3\" class=\"larger\" bgcolor=\"#000000\"><font color=\"#ffffff\">Cross Selling Administration Area</font></td></tr>\n";
...
sub profile {
  ...
  print "<tr><th valign=\"top\" align=\"left\" bgcolor=\"#4a7394\" rowspan=\"1\">Company Profile</th><td align=\"left\" class=\"smaller\" colspan=\"2\">\n";
  print "<form method=\"post\" action=\"xsell_admin.cgi\" target=\"newWin\">\n";
  print "<input type=\"hidden\" name=\"function\" value=\"add_profile\">\n";
  print "<input type=\"submit\" value=\"Edit Company Profile\">\n";
  print "</form>\n";
  print "</td></tr>\n";
}
...
sub import_data {
  ...
  print "<form method=\"post\" enctype=\"multipart/form-data\" action=\"xsell_admin.cgi\" target=\"newWin\">\n";
...
sub addsku {
  ...
  print "<form method=\"post\" action=\"xsell_admin.cgi\" target=\"newWin\">\n";
  print "Product SKU:</th><td class=\"smaller\"><input type=\"text\" name=\"sku\" size=\"20\" maxlength=\"20\"></td></tr>\n";
...
sub documentation {
  ...
  print "<td align=\"left\"><a href=\"javascript:onlinehelp('xsell');\">Documentation</a></td></tr>\n";
}
