...
sub log_in_cookie {
  ...
  #print "  <tr>\n";
  #print "    <td align=\"center\" colspan=\"3\">If you are unable to LOGIN and are using CHROME as your browser.  Please use another Browser.  We have received reports that the latest CHROME update is causing a problem.</td>\n";
  #print "  </tr>\n";
...
sub head {
  ...
  if (($ENV{'REDIRECT_URL'} =~ /courtpay/i) || ($ENV{'SCRIPT_NAME'} =~ /courtpay/i)) {   ####  DCP 20100713
    print "<link href=\"/css/style_security.css\" type=\"text/css\" rel=\"stylesheet\">\n";
