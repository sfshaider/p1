...
my $profile = new PlugNPay::Recurring::Profile('chrisinc', 'chriscust1318923801831');
...
$transaction->setGatewayAccount('chrisinc');
...
$transaction->{'customname99999999'} = 'payscreensVersion';
$transaction->{'customvalue99999999'} = 2;
