...
if ( ( -e "/home/pay1/batchfiles/stopgenfiles.txt" ) || ( -e "/home/pay1/batchfiles/$devprod/fdmsnorth/stopgenfiles.txt" ) ) {
  exit;
}

$cnt = `ps -ef | grep -v grep | grep -v vim | grep perl | grep -c 'fdmsnorth/putfiles.pl'`;
if ( $cnt > 1 ) {
...
if ( !-e "/home/pay1/batchfiles/$devprod/fdmsnorth/$fileyear" ) {
  ...
  print MAILERR "\n";
  print MAILERR "Couldn't create directory $devprod/fdmsnorth/$fileyear.\n\n";
  close MAILERR;
  exit;
}
...
if ( $filecnt >= 3 ) {
  ...
  print MAILERR "To: cprice\@plugnpay.com\n";
  print MAILERR "From: dcprice\@plugnpay.com\n";
  print MAILERR "Subject: fdmsnorth - putfiles FAILURE\n";
  print MAILERR "\n";
...
for ( my $vali = 0 ; $vali < scalar(@sth_batchvalarray) ; $vali = $vali + 1 ) {
  ...
  my $printstr = "before fileencread /home/pay1/batchfiles/$devprod/fdmsnorth/$fileyear/$filename\n";
  &procutils::filewrite( "$username", "fdmsnorth", "/home/pay1/batchfiles/$devprod/fdmsnorth", "ftplog.txt", "append", "misc", $printstr );

  my $msg = &procutils::fileencread( "putfiles", "fdmsnorth", "/home/pay1/batchfiles/$devprod/fdmsnorth/$fileyear", "$filename", "" );
...
dbEOM
    ...
    my $printstr = "before put file   /home/pay1/batchfiles/$devprod/fdmsnorth/$fileyear/$filename  /GPTD5045.$filename.txt\n";
    &procutils::filewrite( "$username", "fdmsnorth", "/home/pay1/batchfiles/$devprod/fdmsnorth", "ftplog.txt", "append", "misc", $printstr );

    $ftp->put_content( "$msg", "/GPTD5045.$filename.txt" );
    ...
    $OUTFILEstr .= "filename: /GPTD5045.$filename.txt\n\n";
    ...
    $OUTFILEstr .= "mailbox: NAGW\-GAGVI001\n";
    $OUTFILEstr .= "inbound job name: GPTD5045\n";
    $OUTFILEstr .= "time: $savtime\n\n";
    &procutils::filewrite( "$username", "fdmsnorth", "/home/pay1/batchfiles/logs/fdmsnorth", "ftpissue.txt", "write", "", $OUTFILEstr );
  }
