...
$cnt = `ps -ef | grep -v grep | grep -v vim | grep perl | grep -c 'fdmsdebit/genfiles.pl'`;
if ( $cnt > 1 ) {
  my $printstr = "genfiles.pl already running, exiting...\n";
  &procutils::filewrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/devlogs/fdmsdebit", "miscdebug.txt", "append", "misc", $printstr );

  open( MAILERR, "| /usr/lib/sendmail -t" );
  print MAILERR "To: cprice\@plugnpay.com\n";
  print MAILERR "From: dcprice\@plugnpay.com\n";
  print MAILERR "Subject: fdmsdebit - genfiles already running\n";
  print MAILERR "\n";
...
$outfilestr .= "$pidline\n";
&procutils::flagwrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/$devprodlogs/fdmsdebit", "pid.txt", "write", "", $outfilestr );

&miscutils::mysleep(2.0);

my @infilestrarray = &procutils::fileread( "$username", "fdmsdebit", "/home/pay1/batchfiles/$devprodlogs/fdmsdebit", "pid.txt" );
...
if ( $pidline ne $chkline ) {
  ...
  print MAILERR "From: dcprice\@plugnpay.com\n";
  print MAILERR "Subject: fdmsdebit - dup genfiles\n";
  print MAILERR "\n";
...
$checkstring = "and username in ('PNP000000005')";
...
if ( !-e "/home/pay1/batchfiles/$devprodlogs/fdmsdebit/$fileyearonly" ) {
  my $printstr = "creating $fileyearonly\n";
  &procutils::filewrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/devlogs/fdmsdebit", "miscdebug.txt", "append", "misc", $printstr );
  system("mkdir /home/pay1/batchfiles/$devprodlogs/fdmsdebit/$fileyearonly");
  chmod( 0700, "/home/pay1/batchfiles/$devprodlogs/fdmsdebit/$fileyearonly" );
}
if ( !-e "/home/pay1/batchfiles/$devprodlogs/fdmsdebit/$filemonth" ) {
  my $printstr = "creating $filemonth\n";
  &procutils::filewrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/devlogs/fdmsdebit", "miscdebug.txt", "append", "misc", $printstr );
  system("mkdir /home/pay1/batchfiles/$devprodlogs/fdmsdebit/$filemonth");
  chmod( 0700, "/home/pay1/batchfiles/$devprodlogs/fdmsdebit/$filemonth" );
}
if ( !-e "/home/pay1/batchfiles/$devprodlogs/fdmsdebit/$fileyear" ) {
  my $printstr = "creating $fileyear\n";
  &procutils::filewrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/devlogs/fdmsdebit", "miscdebug.txt", "append", "misc", $printstr );
  system("mkdir /home/pay1/batchfiles/$devprodlogs/fdmsdebit/$fileyear");
  chmod( 0700, "/home/pay1/batchfiles/$devprodlogs/fdmsdebit/$fileyear" );
}
if ( !-e "/home/pay1/batchfiles/$devprodlogs/fdmsdebit/$fileyear" ) {
  open( MAILERR, "| /usr/lib/sendmail -t" );
  print MAILERR "To: cprice\@plugnpay.com\n";
  ...
  print MAILERR "\n";
  print MAILERR "Couldn't create directory $devprodlogs/fdmsdebit/$fileyear.\n\n";
  close MAILERR;
  exit;
}
...
dbEOM
    ...
    if ( ( $chkstatus eq "live" ) && ( $chkprocessor eq "fdmsdebit" ) ) {
      my $printstr = "b: $user\n";
      &procutils::filewrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/devlogs/fdmsdebit", "miscdebug.txt", "append", "misc", $printstr );
...
if ( $errorflag == 1 ) {
  ...
  print MAILERR "To: cprice\@plugnpay.com\n";
  print MAILERR "From: dcprice\@plugnpay.com\n";
  print MAILERR "Subject: fdmsdebit - Batch Error\n";
  print MAILERR "\n";
...
foreach $username (@userarray) {
  if ( -e "/home/pay1/batchfiles/$devprodlogs/stopgenfiles.txt" ) {
    &procutils::flagwrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/$devprodlogs/fdmsdebit", "batchfile.txt", "unlink", "", "" );
    last;
  }
  ...
  &procutils::flagwrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/$devprodlogs/fdmsdebit", "genfiles.txt", "write", "", $batchfilestr );

  umask 0033;
  $batchfilestr = "";
  $batchfilestr .= "$username\n";
  &procutils::flagwrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/$devprodlogs/fdmsdebit", "batchfile.txt", "write", "", $batchfilestr );
  ...
  $logfilestr = "";
  $logfilestr .= "$username\n";
  &procutils::filewrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/$devprodlogs/fdmsdebit/$fileyear", "t$todaytime.txt", "append", "", $logfilestr );
...
dbEOM
    ...
    $enccardnumber = &smpsutils::getcardnumber( $username, $orderid, "fdmsdebit", $enccardnumber );
...
sub fileheader {
  ...
  $fh[1]  = '000405';                 # presenter's id (6n)
  $fh[2]  = ' ';                      # filler (1a)
  $fh[3]  = 'FD000405';               # pid password (8a)
  $fh[4]  = ' ';                      # filler (1a)
  $fh[5]  = 'SID=';                   # constant (4a)
  $fh[6]  = '000405';                 # submitter's id (6n)
  $fh[7]  = ' ';                      # filler (1a)
  $fh[8]  = 'FD000405';               # sid password (8a)
  $fh[9]  = ' ';                      # filler (1a)
  ...
  $fh[1] = 'RPL006';    # third party processor id (6n)
...
sub filetrailer {
  ...
  $ftr[1]  = '000405';                 # presenter's id (6n)
  $ftr[2]  = ' ';                      # filler (1a)
  $ftr[3]  = 'FD000405';               # pid password (8a)
  $ftr[4]  = ' ';                      # filler (1a)
  $ftr[5]  = 'SID=';                   # constant (4a)
  $ftr[6]  = '000405';                 # submitter's id (6n)
  $ftr[7]  = ' ';                      # filler (1a)
  $ftr[8]  = 'FD000405';               # sid password (8a)
  $ftr[9]  = ' ';                      # filler (1a)
  ...
  &procutils::fileencwrite( "fdmsdebit", "fdmsdebit", "/home/pay1/batchfiles/$devprodlogs/fdmsdebit/$fileyear", "$filename", "write", "", $outfilestr );
  &procutils::filewrite( "fdmsdebit", "fdmsdebit", "/home/pay1/batchfiles/$devprodlogs/fdmsdebit/$fileyear", "$filename.txt", "write", "", $outfile2str );
}
...
sub batchdetail {
  ...
  $morderid = substr( $refnumber, -6, 6 );
  $morderid =~ s/ //g;
  if ( $morderid eq "" ) {
    my $printstr = "new morderid $operation\n";
    &procutils::filewrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/devlogs/fdmsdebit", "miscdebug.txt", "append", "misc", $printstr );

    $morderid = &fdmsdebit::sendmessage( $username, $orderid, "invoicenum" );
  ...
  $morderid = substr( "0" x 8 . $morderid, -8, 8 ) . "0" x 14;    # first 8 chars must be unique

  my $storagemorderid = substr( $morderid, 0, 8 );
...
dbEOM
  ...
  my %inserthash = ( "username", "$username", "filename", "$ttime", "trans_date", "$today", "orderid", "$orderid", "status", "pending", "detailnum", "$storagemorderid", "processor", "fdmsdebit" );
...
dbEOM
  ...
  if ( $marketdata ne "" ) {
    ...
    $dbaphone =~ tr/a-z/A-Z/;
    $dbaphone =~ s/[^0-9A-Z]//;
    $dbaphone = substr( $dbaphone,            0, 3 ) . "-" . substr( $dbaphone, 3 );
  ...
  if (0) {
    ...
    $bdab[2] = " " x 8;     # auth trace number (8a)
    my $oid = substr( $orderid . " " x 25, 0, 25 );
  ...
  if ( $industrycode eq "retail" ) {
    ...
    #$tid = substr($terminal_id . " " x 16,0,16);
...
sub pidcheck {
  ...
  if ( $pidline ne $chkline ) {
    ...
    $logfilestr .= "$pidline\n";
    $logfilestr .= "$chkline\n";
    &procutils::filewrite( "$username", "fdmsdebit", "/home/pay1/batchfiles/$devprodlogs/fdmsdebit/$fileyear", "$username$time$pid.txt", "append", "", $logfilestr );
