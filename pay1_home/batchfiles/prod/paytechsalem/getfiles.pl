...
if ( !-e "/home/pay1/batchfiles/$devprod/paytechsalem/$fileyearonly" ) {
  my $printstr = "creating $fileyearonly\n";
  &procutils::filewrite( "$username", "paytechsalem", "/home/pay1/batchfiles/$devprod/paytechsalem", "ftplog.txt", "append", "misc", $printstr );
  system("mkdir /home/pay1/batchfiles/$devprod/paytechsalem/$fileyearonly");
  system("chmod go-rwx /home/pay1/batchfiles/$devprod/paytechsalem/$fileyearonly");
}
if ( !-e "/home/pay1/batchfiles/$devprod/paytechsalem/$filemonth" ) {
  my $printstr = "creating $filemonth\n";
  &procutils::filewrite( "$username", "paytechsalem", "/home/pay1/batchfiles/$devprod/paytechsalem", "ftplog.txt", "append", "misc", $printstr );
  system("mkdir /home/pay1/batchfiles/$devprod/paytechsalem/$filemonth");
  system("chmod go-rwx /home/pay1/batchfiles/$devprod/paytechsalem/$filemonth");
}
if ( !-e "/home/pay1/batchfiles/$devprod/paytechsalem/$fileyear" ) {
  my $printstr = "creating $fileyear\n";
  &procutils::filewrite( "$username", "paytechsalem", "/home/pay1/batchfiles/$devprod/paytechsalem", "ftplog.txt", "append", "misc", $printstr );
  system("mkdir /home/pay1/batchfiles/$devprod/paytechsalem/$fileyear");
  system("chmod go-rwx /home/pay1/batchfiles/$devprod/paytechsalem/$fileyear");
}
if ( !-e "/home/pay1/batchfiles/$devprod/paytechsalem/$fileyear" ) {
  ...
  print MAILERR "\n";
  print MAILERR "Couldn't create directory logs/paytechsalem/$fileyear.\n\n";
  close MAILERR;
  exit;
}
...
if ( $redofile eq "" ) {
  ...
  foreach my $var (@$ls) {
    ...
    $ftp->get( "prod/data/292961/$fn", "/home/pay1/batchfiles/$devprod/paytechsalem/$fileyear/$fn" );
    system("chmod go-rwx /home/pay1/batchfiles/$devprod/paytechsalem/$fileyear/*");
    ...
    $printstr .= "\n";
    &procutils::filewrite( "paytechsalem", "accountupd", "/home/pay1/batchfiles/$devprod/paytechsalem", "ftplog.txt", "append", "misc", $printstr );

    my $fileencstatus = &procutils::fileencwrite( "paytechsalem", "getfiles", "/home/pay1/batchfiles/$devprod/paytechsalem/$fileyear", "$fn", "write", "", $outboxfilestr );

    my $outfiletxtstr = "fileencwrite status: $fileencstatus /home/pay1/batchfiles/$devprod/paytechsalem/$fileyear/$fn\n";    # create a basic file so we know the file is stored in enc area
    &procutils::filewrite( "paytechsalem", "getfiles", "/home/pay1/batchfiles/$devprod/paytechsalem/$fileyear", "$fn.txt", "write", "", $outfiletxtstr );
...
foreach $filename (@list) {
  my $printstr = "$fileyear $filename  /home/pay1/batchfiles/$devprod/paytechsalem/$fileyear/$filename\n";
  &procutils::filewrite( "$username", "paytechsalem", "/home/pay1/batchfiles/$devprod/paytechsalem", "ftplog.txt", "append", "misc", $printstr );
  ...
  my $infilestr = &procutils::fileencread( "$username", "paytechsalem", "/home/pay1/batchfiles/$devprod/paytechsalem/$fileyear", "$filename" );
...
dbEOM
      ...
      if ( $depositflag eq "N" ) {
        ...
        print MAILERR "To: cprice\@plugnpay.com\n";
        print MAILERR "From: dcprice\@plugnpay.com\n";
        print MAILERR "Subject: paytechsalem - $username FAILURE\n";
        print MAILERR "\n";
...
foreach $filename ( keys %unlinkarray ) {
  ...
  unlink "/home/pay1/batchfiles/$devprod/paytechsalem/$year/$filename";
}
