...
if ( ( -e "/home/pay1/batchfiles/stopgenfiles.txt" ) || ( -e "/home/pay1/batchfiles/$devprodlogs/fdmsrc/stopgenfiles.txt" ) ) {
  exit;
}
...
$outfilestr .= "$pidline\n";
&procutils::filewrite( "$username", "fdmsrc", "/home/pay1/batchfiles/$devprodlogs/fdmsrc", "pid$group.txt", "write", "", $outfilestr );

&miscutils::mysleep(2.0);

my @infilestrarray = &procutils::fileread( "$username", "fdmsrc", "/home/pay1/batchfiles/$devprodlogs/fdmsrc", "pid$group.txt" );
...
if ( !-e "/home/pay1/batchfiles/$devprodlogs/fdmsrc/$fileyearonly" ) {
  my $printstr = "creating $fileyearonly\n";
  &procutils::filewrite( "$username", "fdmsrc", "/home/pay1/batchfiles/devlogs/fdmsrc", "miscdebug.txt", "append", "misc", $printstr );
  system("mkdir /home/pay1/batchfiles/$devprodlogs/fdmsrc/$fileyearonly");
  chmod( 0700, "/home/pay1/batchfiles/$devprodlogs/fdmsrc/$fileyearonly" );
}
if ( !-e "/home/pay1/batchfiles/$devprodlogs/fdmsrc/$filemonth" ) {
  my $printstr = "creating $filemonth\n";
  &procutils::filewrite( "$username", "fdmsrc", "/home/pay1/batchfiles/devlogs/fdmsrc", "miscdebug.txt", "append", "misc", $printstr );
  system("mkdir /home/pay1/batchfiles/$devprodlogs/fdmsrc/$filemonth");
  chmod( 0700, "/home/pay1/batchfiles/$devprodlogs/fdmsrc/$filemonth" );
}
if ( !-e "/home/pay1/batchfiles/$devprodlogs/fdmsrc/$fileyear" ) {
  my $printstr = "creating $fileyear\n";
  &procutils::filewrite( "$username", "fdmsrc", "/home/pay1/batchfiles/devlogs/fdmsrc", "miscdebug.txt", "append", "misc", $printstr );
  system("mkdir /home/pay1/batchfiles/$devprodlogs/fdmsrc/$fileyear");
  chmod( 0700, "/home/pay1/batchfiles/$devprodlogs/fdmsrc/$fileyear" );
}
if ( !-e "/home/pay1/batchfiles/$devprodlogs/fdmsrc/$fileyear" ) {
  open( MAILERR, "| /usr/lib/sendmail -t" );
  print MAILERR "To: cprice\@plugnpay.com\n";
...
foreach $key ( sort keys %userbankarray ) {
  ...
  if ( ( -e "/home/pay1/batchfiles/stopgenfiles.txt" ) || ( -e "/home/pay1/batchfiles/$devprodlogs/fdmsrc/stopgenfiles.txt" ) ) {
    ...
    &procutils::filewrite( "$username", "fdmsrc", "/home/pay1/batchfiles/devlogs/fdmsrc", "miscdebug.txt", "append", "misc", $printstr );
    &procutils::filewrite( "$username", "fdmsrc", "/home/pay1/batchfiles/$devprodlogs/fdmsrc/$fileyear", "$username$time$pid.txt", "append", "", $logfilestr );

    &procutils::flagwrite( "$username", "fdmsrc", "/home/pay1/batchfiles/$devprodlogs/fdmsrc", "batchfile.txt", "unlink", "", "" );
    last;
  }
  ...
  &procutils::filewrite( "$username", "fdmsrc", "/home/pay1/batchfiles/$devprodlogs/fdmsrc", "genfiles$group.txt", "write", "", $batchfilestr );
  ...
  $batchfilestr = "";
  $batchfilestr .= "$username\n";
  &procutils::filewrite( "$username", "fdmsrc", "/home/pay1/batchfiles/$devprodlogs/fdmsrc", "batchfile.txt", "write", "", $batchfilestr );
...
$outfilestr = "";
$outfilestr .= "\n\n$mytime\n";
&procutils::filewrite( "$username", "fdmsrc", "/home/pay1/batchfiles/$devprodlogs/fdmsrc", "ftplog.txt", "append", "", $outfilestr );

if ( ( $filecount > 0 ) && ( $filecount < 4 ) ) {
  for ( $myi = 0 ; $myi <= $filecount ; $myi++ ) {

    system("/home/pay1/batchfiles/$devprod/fdmsrc/putfiles.pl 2>\&1");
    &miscutils::mysleep(120);
    system("/home/pay1/batchfiles/$devprod/fdmsrc/getfiles.pl 2>\&1");
...
sub batchdetail {
  ...
  $bd[10] = $posentry;     # entry mode (1a)
                           #my $printstr = "magstatus: $magstatus  posentry: $posentry  ";
                           #&procutils::filewrite("$username","fdmsrc","/home/pay1/batchfiles/devlogs/fdmsrc","scriptresults2.txt","append","misc",$printstr);
  ...
  if (
    ...
    } elsif ( ( $card_type =~ /(vi)/ ) && ( $operation eq "postauth" ) && ( $transflags =~ /bill/ ) ) {
  ...
  if ( ( ( $card_type =~ /(vi|ax)/ ) || ( $transflags =~ /star/ ) ) && ( $origoperation ne "forceauth" ) && ( $operation ne "xreturn" ) ) {
  ...
  if (
    ...
    if ( ( $card_type eq "mc" ) && ( $reauthstatus eq "success" ) && ( $operation eq "postauth" ) ) {
      $idformat = " ";
    } elsif ( ( $card_type eq "vi" ) && ( ( $industrycode !~ /retail|restaurant/ ) || ( $transflags =~ /(moto|bill|recur|install|mit|cit)/ ) ) && ( $commflag ne "x1" ) ) {
      $idformat = "1";
    }
  ...
  if ( ( $operation eq "return" ) && ( $transdate eq "" ) ) {
    $transdate = substr( $todaylocal, 4, 4 );
  }
  $transdate = substr( $transdate . " " x 4, 0, 4 );
...
sub batchheader {
  ...
  # xxxx this is only for batches with an amex card in it
  if ( ( $axarray{"$username $marketdata"} == 1 ) && ( $chargedescr ne "" ) ) {
    @bh = ();
    $bh[0] = "R";    # record id (1a)
...
sub filetrailer {
  ...
  my $filestatus = &procutils::fileencwrite("$username","fdmsrc","/home/pay1/batchfiles/$devprodlogs/fdmsrc/$fileyear","$filename","write","",$outfilestr);
  $outfile2str .= "\nfileencwritestatus: $filestatus\n";
  &procutils::filewrite( "$username", "fdmsrc", "/home/pay1/batchfiles/$devprodlogs/fdmsrc/$fileyear", "$filename.txt", "write", "", $outfile2str );
